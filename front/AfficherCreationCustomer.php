  ...
  <div >
    ...
    <div>
      <form method="POST" action="./faireCreationCustomer.php">
        ...
        <div>Statut : <input required type="text" name="statut" placeholder="Statut"></div>
        <div>Mot de passe : <input required type="text" name="password" placeholder="Password"></div>
